...
namespace EmotionalBasketGame.Actors
{
    ...
    /// Handles game FPS.
    /// </summary>
    public class Ink_Config_FPS : Ink_ConfigHandler_Base
    {
        ...
        public Ink_Config_FPS()
        {
            configName = "Framerate";
        }
        ...
        public override void Draw(GameTime gameTime, SpriteBatch spriteBatch)
        {
            ...
            if (options != null)
            {
                string displayStr = options[selectedIdx] < 0 ? "Uncap" : options[selectedIdx].ToString();
        ...
        public override void ApplySettings()
        {
            ...
            gameSettings.FPS = options[selectedIdx];
        }
